...
RS_MODULES.modules["revslider51"] = {
   once: RS_MODULES.modules["revslider51"] !== undefined ? RS_MODULES.modules["revslider51"].once : undefined, init: function () {
      ...
      revapi5.revolutionInit({
         ...
         visibilityLevels: "1240,1024,778,480",
         gridwidth: "1300,1024,778,480",
         gridheight: "1080,768,600,600",
         lazyType: "smart",
         perspective: 600,
         perspectiveType: "global",
         editorheight: "1080,768,600,600",
         responsiveLevels: "1240,1024,778,480",
         progressBar: { disableProgressBar: true },
         navigation: {
            wheelCallDelay: 1000,
...
RS_MODULES.modules["revslider61"] = {
   once: RS_MODULES.modules["revslider61"] !== undefined ? RS_MODULES.modules["revslider61"].once : undefined, init: function () {
      ...
      revapi6.revolutionInit({
         ...
         visibilityLevels: "1240,1024,778,480",
         gridwidth: "1300,1024,778,480",
         gridheight: "1080,768,600,650",
         lazyType: "smart",
         perspective: 600,
         perspectiveType: "global",
         editorheight: "1080,768,600,650",
         responsiveLevels: "1240,1024,778,480",
         progressBar: { disableProgressBar: true },
         navigation: {
            wheelCallDelay: 1000,
...
RS_MODULES.modules["revslider71"] = {
   once: RS_MODULES.modules["revslider71"] !== undefined ? RS_MODULES.modules["revslider71"].once : undefined, init: function () {
      ...
      revapi7.revolutionInit({
         ...
         gridheight: "950,768,600,620",
         lazyType: "smart",
         perspective: 600,
         perspectiveType: "global",
         editorheight: "950,768,600,620",
         responsiveLevels: "1240,1024,778,480",
         progressBar: { disableProgressBar: true },
         navigation: {
            wheelCallDelay: 1000,
